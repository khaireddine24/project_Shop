...
export class AuthService {
  users: Compte[] = [
    {nom:"administrateur", email:"admin@gmail.com", mot2pass:"123",tel:"",adresse:"",role:"ADMIN"},
    {nom:"ihrissane", email:"ihrissanek@gmail.com", mot2pass:"azerty",tel:"",adresse:"",role:"AGENT"} 
  ];
